    ...
    <div className="min-h-screen bg-white font-inter relative overflow-hidden">
      ...
      <header className="relative z-50 px-4 md:px-8 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <a href="/" className="text-2xl font-michroma tracking-wider">
            SnaripStudio
          </a>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="text-center p-8 bg-gray-50 hover:bg-gray-100 transition-colors group">
              ...
              <h3 className="text-2xl font-michroma mb-4">WHATSAPP</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
      ...
      <section className="px-4 md:px-8 py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-michroma mb-8">
            WHAT HAPPENS NEXT?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <h3 className="font-michroma text-lg mb-2">PROPOSAL</h3>
              <p className="text-gray-600 text-sm">
      ...
      <footer className="bg-[#0a0a0a] text-white px-4 md:px-8 py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <a
            href="/"
            className="text-2xl font-michroma tracking-wider mb-8 inline-block"
          >
            SnaripStudio
          </a>
