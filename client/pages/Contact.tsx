        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="text-center p-8 bg-card hover:bg-card/80 transition-colors group border border-border rounded-lg">
              ...
              <h3 className="text-2xl font-montserrat text-foreground mb-4">EMAIL US</h3>
            ...
            <div className="text-center p-8 bg-card hover:bg-card/80 transition-colors group border border-border rounded-lg">
              ...
              <h3 className="text-2xl font-montserrat text-foreground mb-4">WHATSAPP</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <h3 className="font-montserrat text-foreground text-lg mb-2">DISCOVERY CALL</h3>
            ...
            <div>
              ...
              <h3 className="font-montserrat text-foreground text-lg mb-2">PROPOSAL</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div>
              ...
              <h3 className="font-montserrat text-foreground text-lg mb-2">PROJECT START</h3>
              <p className="text-muted-foreground text-sm">
