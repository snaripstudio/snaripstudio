  ...
  return (
    <div className="scroll-container">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center animate-on-scroll fade-up">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Full-Stack Development & SEO Foundation for a Local Service
              Business
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <div className="text-center animate-on-scroll fade-up">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-8 text-lg">
              <p>
                RihandCabs.in is a web presence developed for a local cab
                service operating on the niche route between Rihand and
                Varanasi, India. The project's goal was to create a fast,
                reliable, and professional online platform to attract local
                customers, build trust, and generate direct booking inquiries.
              </p>
              <p>
                I served as the lead developer and technical consultant,
                responsible for the entire project lifecycle from initial
                strategy to deployment, optimization, and search engine setup.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="scroll-section bg-card">
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <div className="animate-on-scroll fade-up">
            <h2 className="text-3xl md:text-5xl font-inter text-foreground mb-12 text-center">
              The Challenge
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 text-center">
              The client needed to establish a digital footprint from scratch in
              a hyper-local market. The key challenges were:
            </p>
      ...
      <section className="scroll-section bg-background">
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <div className="animate-on-scroll fade-up">
            <h2 className="text-3xl md:text-5xl font-inter text-foreground mb-8 text-center">
            ...
            <div className="bg-card p-8 rounded-lg">
              <h3 className="text-2xl font-inter text-foreground mb-6 text-center">
                Domain Strategy
              </h3>
              <p className="text-lg text-muted-foreground leading-relaxed text-center">
                We began by choosing the{" "}
                <code className="bg-muted px-3 py-1 rounded text-base">
                  .in
                </code>{" "}
                country-code top-level domain (ccTLD) over a generic{" "}
                <code className="bg-muted px-3 py-1 rounded text-base">
                  .com
                </code>
                . This was a deliberate decision to immediately signal to both
                users and search engines that the business is local to India,
                thereby enhancing local SEO and building regional trust.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div className="bg-background p-8 rounded-lg">
                <h3 className="text-xl font-medium text-foreground mb-4 text-center">
                  Modern React Framework + Netlify Deployment
                </h3>
                <p className="text-muted-foreground leading-relaxed text-center">
                  The website was built using a modern React framework and
                  deployed on Netlify for its high-performance edge network and
                  CI/CD capabilities.
                </p>
              </div>
              <div className="bg-background p-8 rounded-lg">
                ...
                <p className="text-muted-foreground leading-relaxed text-center">
                  A significant challenge was integrating the GoDaddy-registered
                  domain with Netlify's hosting. I successfully navigated a
                  complex DNS configuration, diagnosing and rectifying an
                  initial domain forwarding setup and implementing a robust
                  nameserver delegation to Netlify DNS.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <div className="animate-on-scroll fade-up text-center">
            ...
            <div className="bg-card p-8 rounded-lg max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Replaced heavy JavaScript animations with lightweight WebP
                images for mobile users, while maintaining rich animations for
                desktop experiences.
              </p>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Established website relationship with Google, troubleshooting DNS record types (TXT vs A records)",
                },
                {
                  title: "Sitemap Submission",
                  description:
                    "Debugged and submitted valid sitemap.xml after fixing pathing errors and incorrect base URLs",
                },
                {
                  title: "Indexing Lifecycle",
                  description:
                    "Guided client from 'Discovered - not indexed' to 'URL is on Google' confirmation",
                },
                {
                  title: "Google Business Profile",
                  description:
                    "Established GBP as primary tool for local customer acquisition and optimization",
                },
              ].map((item, index) => (
          ...
          <div className="animate-on-scroll fade-up">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="flex gap-3 p-6 bg-card rounded-lg text-center"
                >
      ...
      <section className="scroll-section bg-card">
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <div className="animate-on-scroll fade-up text-center">
            <h2 className="text-3xl md:text-5xl font-inter text-foreground mb-12">
              The Outcome
            </h2>
            <div className="bg-gradient-to-r from-primary/20 to-accent/20 p-12 rounded-lg">
              ...
              <p className="text-xl text-foreground leading-relaxed max-w-3xl mx-auto">
                The result is a secure, professionally deployed, and highly
                performant website that is now fully indexed by Google. The{" "}
                <strong>rihandcabs.in</strong> project now has a strong
                technical foundation with a clear strategy centered around
                Google Business Profile to capture local search traffic and
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          <div className="animate-on-scroll fade-up">
            ...
            <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
              Let's discuss how we can create a powerful digital presence for
              your business with strategic development and optimization.
            </p>
